...
export default function Footer() {
  ...
  return (
    <div
      className={`container border border-t-gray border-l-0 border-r-0 mt-[1rem] `}
    >
      <div
        className={`container mx-auto sm:px-2 px-1 pt-8 xl:px-32 lg:px-10 3xl:px-52 xl:py-4 lg:py-4 md:py-4 3xl:py-8 bg-transparent text-dark ${
        ...
        <div className="grid grid-cols-1 3xl:grid-cols-3 sm:grid-cols-2 md:grid-cols-2 md:gris-rows-2  justify-between items-start ">
          ...
          <div className="flex flex-col items-start 3xl:w-80 sm:w-full sm:mt-10 bg-gray 3xl:px-4 py-4 sm:col-span-2">
            <div className="text-xl font-light sm:text-base">
              Subscribe to our newsletter to get all the stories straight in
              your inbox
            </div>
            ...
            <form className="my-4 flex w-full">
              <Input
                ...
                className="border border-gray rounded-lg px-3 py-2 w-full"
                value={email}
                required={false}
                withlabel={false}
                label=""
              ...
              >
                <img
                  src="/assets/images/icons/arrows/right.png"
                  alt="send"
                  className="h-3 w-3"
                />
              </Button>
      ...
      <div className="container mx-auto px-5 xl:px-20 lg:px-20 3xl:px-40 xl:py-4 lg:py-4 md:py-4 3xl:py-4 bg-transparent text-dark sm:px-4 sm:py-2">
        <div className="flex flex-col sm:flex-col  md:flex-col 3xl:flex-row justify-between items-center md:items-center">
          ...
          <div className="flex items-center my-4">
            ...
            <span className="text-center sm:mb-2 sm:text-xs 3xl:px-4 lg:px-3 md:px-3 font-light xl:text-md">
              © 2023 3WEBLABS{" "}
              <span className="font-bold ">Powered by ABCD Technologies.</span> All Rights
              Reserved.
            </span>
          </div>
          ...
          <div className="flex items-center sm:my-2">
            <span className="mx-4">
              <a
                href="https://www.linkedin.com/company/3-weblabs/"
                target="_blank"
                rel="noopener noreferrer"
              >
                <i className="fa-brands fa-linkedin text-xl text-black "></i>
              </a>
            </span>
            <span className="mx-4">
              <a
                href="https://twitter.com/3weblabs"
                target="_blank"
                rel="noopener noreferrer"
              >
            ...
            <span className="mx-4">
              <a
                ...
                rel="noopener noreferrer"
              >
                <i className="fa-brands fa-discord text-xl text-black "></i>
              </a>
            </span>
            <span className="mx-4">
              <a
                href="https://github.com/theOpenBuilD"
                target="_blank"
                rel="noopener noreferrer"
              >
