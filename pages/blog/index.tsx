...
export default function BlogPosts() {
  ...
  return (
    <div>
      <SEO title="Blog " description="Checkout our well curated articles to help you take your career to the next level." />
      ...
      <div className='h-60 flex px-40 sm:px-4 justify-between items-center border-2 border-b-white border-r-0 border-t-0 border-l-0 sm:h-42'>
        <h1 className="text-4xl font-semibold sm:text-2xl">Blog</h1>
      </div>
