    ...
    >
      <div className="p-10">
        <div className="w-full">
          <img
            alt="exit"
            className="h-4 mb-5 float-right cursor-pointer"
        ...
        <div className="flex flex-col items-center justify-center mt-12">
          ...
          <p className="text-sm font-light text-center text-slate-500">
          ...
          <div className="rounded-3xl p-2 flex shadow-2xl my-4">
            <Input
              ...
              type="email"
              className="border-none sm:text-xs sm:text-bold enabled:hover:border-gray-400 required:border-red-500
          focus:ring-sky-500
      ...
      focus:invalid:border-red-500 focus:invalid:ring-red-500
          "
            ...
            <Button
              loading={loading}
              disabled={loading}
              onClick={handleMailSubscription}
              className="rounded-l-3xl rounded-r-3xl sm:text-xs sm:text-bold mr-0 ml-0 sm:rounded-l-3xl sm:rounded-r-3xl "
            >
              Subscribe
            </Button>
          </div>
...
const Home: NextPage = () => {
  ...
  return (
    <div className="mt-[1rem] home">
      <SubScribeToNewLetterModal
        closed={() => setShowNewsletter(false)}
        show={showNewsLetter}
      />

      <SEO
        title="Home"
        description="Hire Top African Designers and Developers."
      />

      <div className="mx-44 border lg:mx-28 border-white sm:mx-2 cursor-pointer">
        <div className="grid grid-cols-2 grid-rows-1 h-[20rem] sm:h-[13rem]">
          <div
            className="flex justify-center items-center p-[7rem] sm:p-[1rem] font-semibold text-4xl lg:text-2xl border border-white sm:text-sm 3xl:leading-[3rem] bg-cover bg-[url('/assets/images/bg/Rectangle39772.svg')] "
            onClick={() => push("/for-companies")}
          >
            Hire Top African Designers and Developers.
          </div>
          <div
            className="flex justify-center items-center p-[7rem] sm:p-[1rem] font-semibold text-4xl lg:text-2xl sm:text-sm  border border-white 3xl:leading-[3rem] bg-cover bg-[url('/assets/images/bg/Rectangle39772.svg')]"
            onClick={(e) => setShowNewsletter(true)}
          >
            Subscribe to Our Newsletter
          </div>
        </div>
        <div className="grid grid-rows-2 grid-cols-3 grid-flow-col gap-0 cursor-pointer bg-[rgba(255,255,255,0.2)] backdrop-opacity-10 ">
          <div
            className="border border-white h-[20rem] sm:h-[13rem] flex justify-center items-center  font-semibold text-4xl lg:text-2xl sm:text-sm "
            onClick={() => push("/blog")}
          >
            Blog
          </div>
          ...
          <div
            className="col-span-2 border border-white flex justify-center items-center  font-semibold text-4xl lg:text-2xl sm:text-sm  h-[20rem] sm:h-[13rem] flex-col pl-8"
            onClick={(e) => setShowingPartners(!showingPartners)}
          >
            {showingPartners ? (
              <div className="w-full partners  carousel">
                <Slider {...settings}>
                  <div className="">
                    <img
                      alt="empowa"
                      src="/assets/images/partners/empowa.png"
                      className="sm:h-6 h-16"
                    />
                  </div>
                  <div className="">
                    <img
              ...
              <div className="transition-all ease-in partners mt-10">
                Partners
              </div>
            )}
          </div>
          ...
          <div
            className="border border-white flex justify-center items-center  font-semibold text-4xl lg:text-2xl sm:text-sm  h-[20rem] sm:h-[13rem]"
      ...
      <h3 className="text-4xl lg:text-2xl pb-10 sm:pb-5 font-medium">Our Partners</h3>
